...
- 🎓 [**FinSim**](https://github.com/AlexAnys/finsim_Mini) — 面向中国高校的 AI 金融教育平台——学生与 AI 模拟客户进行实战对话训练
- 🖥️ [**安澜终端**](https://anlan.ai) — 领域专家的 AI 工作台——自然语言进，可用软件出
- 🗣️ [**typeless-lite**](https://github.com/AlexAnys/typeless-lite) — 语音输入整理工具——自动按天整理转写，关联应用与项目
